...
public class SwaggerConfig {
	...
	public Docket productApi()
	{
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.project.report.controller"))
	...
	{
		return new ApiInfo("Report Generate application",
						   "Report Generate application Description",
						   "1.0",
